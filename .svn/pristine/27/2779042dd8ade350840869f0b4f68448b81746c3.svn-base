...
//			var height = document.body.clientHeight-(offset.top + input.offsetHeight);
			...
			console.log(" padding-right = "+$(input).css("padding-right").substring(0,$(input).css("padding-right").indexOf("px")));
			...
			if(height > options.scrollHeight){
				element.css({
					width:  $(input).width()+ Number($(input).css("padding-right").substring(0,$(input).css("padding-right").indexOf("px"))),
