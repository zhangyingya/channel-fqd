...
DateUtils = (function(){
    ...
    */
    ...
    return {
        ...
        /**
         * 获取连续N月的  yyyy-mm 格式（本月前一月开始）
         * 用于显示下拉框 《账期》
         */
        getYearMonthSelect: function(mount){
        	var date = new Date();
        	var curYear = date.getFullYear();
        	var curMonth = date.getMonth() + 1;	//0-11
        	
        	var preMonth = curMonth;
        	var preYear = curYear;
        	...
        	for(var i = 0; i < 12; i++){
            	...
            	//下拉框最开始要为前一月
            	var codeVal = preYear + preMonth;
            	var codeName = preYear + "-" + preMonth;
            	
        		var monthDataJson = {};
        		monthDataJson.codeVal = codeVal;
        		monthDataJson.codeName = codeName;
        		monthDataArr.push(monthDataJson);
        	}
        	return monthDataArr;
        }
    };
