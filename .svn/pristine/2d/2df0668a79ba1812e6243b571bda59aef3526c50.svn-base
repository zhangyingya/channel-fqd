+(function($, window, document,undefined) {
    ...
    Canvas.prototype = {
		...
		// },
		drawText: function(c_obj){
			var obj = c_obj.$element;
			var $numObj = $(obj).parent().find(".number");
			$numObj.css({
				"color":c_obj.options.fontColor,
				"fontSize":c_obj.options.fontSize + "px",
				"top":c_obj.options.fontY + "px"
			});
			$numObj.html(c_obj.options.value);
		},
