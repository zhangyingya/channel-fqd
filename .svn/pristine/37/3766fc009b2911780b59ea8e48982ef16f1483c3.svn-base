...
var ChooseVillageInfo = function () {
    ...
    */
    ...
    this.getParam = function(){
    	...
    	var townName = decodeURI(decodeURI(Dic.Url.getParams('townName')));
    	var param = {
    			"latnId" : latnId,
    ...
    this.initTable = function(){
        ...
        _this.table = Dic.table.build({
            ...
            waitTime : 15,
            initParam: param,
            url : ctx + 'generalChannel/findVillageNames.do',
            head : [
            	{dis:'行政村', 	name:'villageName', checked:true,width:'1%',align:'left',freeze:true},
    ...
    this.chooseEvent = function() {
        ...
        if(chooseCount == 0){
            ...
            for (var i=0;i<choosedArr.length; i++) {
            	var chooseVillage = {
            			villageName: choosedArr[i].villageName,
            ...
            //返回参数
            parent.getChildIframeVillageData(chooseVillages);
            //关闭父页面
