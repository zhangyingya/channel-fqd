...
(function(factory) {
    ...
    Validator.prototype = {
        ...
        _focusin: function(e) {
            ...
            if (me.verifying || (e.type==='click' && document.activeElement === el)) return;
        ...
        _focusout: function(e, elem) {
            ...
            if (!special) {
                ...
                if (etype === 'focusout') {
                    ...
                    if (!timely || timely < 2 && !e.data) return;

                    // mark timestamp to reduce the frequency of the received event
                    timestamp = +new Date();
                    if ( timestamp - (el._ts || 0) < 100 || (etype === 'keyup' && el._et === 'input') ) return;
                    el._ts = timestamp;
                    el._et = etype;
        ...
        _validatedRule: function(el, field, ret, msgOpt) {
            ...
            // message analysis, and throw rule level event
                ...
                if (!isValid) field.isValid = false;
                msgOpt.msg = msg;
    ...
    (function(URI){
        ...
        if (arr) {
            ...
            if (!URI) {
                ...
                if(arr[2] == 'auto') {	// 如果是auto获取则根据Dic.defaultI18n
                    el.src = dir + 'local/' + (Dic.defaultI18n || 'zh-CN').replace('_','-') + '.js';
                } else {
